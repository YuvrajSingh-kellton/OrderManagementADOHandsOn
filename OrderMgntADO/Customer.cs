...
namespace OrderMgntADO
{
    ...
    {
        private static readonly string connectionStr = @"Data Source=DESKTOP-0P56O06;Initial Catalog=NetFramework;Integrated Security=True";
        private readonly SqlConnection connection = new SqlConnection(connectionStr);
        ...
        add:
            try
            {
                try
                {
                    ...
                    Console.WriteLine("Enter the Phone Number It Should be Cantain Only 10 Digits Number");
                ...
                {
                    Console.WriteLine(" You Missed Some Valus");
        ...
        {
        deleteAgain:
            Console.WriteLine("Enter The Valid Eamil to delete");
            Email = Console.ReadLine();
            if (validmail(Email))
            {
                if (CustomerExistOrNot(Email))
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Do You Want To Delete More \n              press :1");
            ...
            {
                Console.WriteLine();
                Console.WriteLine("Enter Valid Email Addres: Email Format Not Correct => " + Email);
                goto deleteAgain;
        ...
        updateAgain:
            try
            {
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("  You Enter  Incorrect Detail...");
        ...
        {
            string from = "1745.rajput@gmail.com";
            string password = "1745Yuvi";
